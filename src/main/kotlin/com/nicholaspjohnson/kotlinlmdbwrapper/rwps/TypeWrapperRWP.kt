...
class TypeWrapperRWP<M: LMDBObject<M>, R, D>(private val underlying: AbstractRWP<M, D?>, private val fromDBToObj: (D) -> R, private val fromObjToDB: (R) -> D, lmdbObject: LMDBObject<M>, nullable: Boolean) :
